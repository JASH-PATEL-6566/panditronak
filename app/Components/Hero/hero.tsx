    ...
    <div className="w-full px-10 h-screen relative bg-transparent">
      ...
      <div className="pandit_subinfo absolute w-7/12 left-12  top-[45%] font-[Suisse init] text-xl font-normal text-[#D7492B] overflow-hidden ">
        <h1 className="subinfo flex flex-col">
          <span>With over 20 years of experience in Vedic traditions, I am dedicated to preserving</span> 
          <span>and sharing the rich cultural heritage of Indian rituals. My journey in this sacred field</span> 
          <span>has been one of continuous learning and deep spiritual connection.</span>
        </h1>
      </div>
      <div className="button absolute top-[70%] left-12 overflow-hidden">
        <div className="buttontext px-5 py-3 rounded-full bg-[#d7482b15] ">hello@vyas.com</div>
      </div>
